...
namespace GPSReader.USB.Classes
{
    public static class DeviceCommunication
    {
        ...
        /// 读取USB外设数据
        /// </summary>
        /// <param name="inputReportBuffer">读取的数据</param>
        ...
        /// </summary>
        /// <param name="inputReportBuffer"></param>
        /// <param name="numberOfReports">读取的Report数量</param>
        /// <param name="deviceInformation">USB外设</param>
        /// <returns></returns>
        public static bool ReadMultipleReportsFromDevice(ref byte[] inputReportBuffer, int numberOfReports, ref DeviceInformationStructure deviceInformation)
        {
            ...
            //定义用于将部分数据读取组合到完成的inputReportBuffer中的临时缓冲区
